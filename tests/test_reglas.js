...
console.log('redondeoCantidadZona (default round):');
ok(R.redondeoCantidadZona(150, 10) === 15, '150/10 = 15');
ok(R.redondeoCantidadZona(300, 20) === 15, '300/20 = 15');
ok(R.redondeoCantidadZona(155, 10) === 16, '155/10 = 15.5 → round = 16');
ok(R.redondeoCantidadZona(0, 10) === 0, 'longitud 0 → 0');
...
// zona1: 150/10=15, zona2: 300/20=15, zona3: 150/10=15 → 45 (algunos pueden cortarse por x1)
var porZona = {};
...
ok(plES.length >= 40 && plES.length <= 46, 'total estribos plausible (' + plES.length + ')');
