...
| Módulo (caluga)              | admin | admin_calidad | cubicador | usc   | externo | cliente |
| ---------------------------- |:-----:|:------:|:---------:|:-----:|:-------:|:-------:|
| Cubicación                   |  ✅   |   ✅   |    ✅     |   —   |    —    |   ✅    |
| Reclamos                     |  ✅   |   ✅   |    ✅     |  ✅   |   ✅    |    —    |
| Administración               |  ✅   |   ✅   |     —     |   —   |    —    |    —    |
...
| Módulo         | Tab              | admin | admin_calidad | cubicador | usc   | externo | cliente |
| -------------- | ---------------- |:-----:|:------:|:---------:|:-----:|:-------:|:-------:|
| **Cubicación** | Obras            |  ✅   |   ✅   |    ✅     |   —   |    —    |    —    |
| **Cubicación** | Metrics          |  ✅   |   ✅   |    ✅     |   —   |    —    |   ✅    |
...
| Indicador                    | admin    | admin_calidad   | cubicador      | usc          | externo      | cliente |
| ---------------------------- |:--------:|:--------:|:--------------:|:------------:|:------------:|:-------:|
...
| Vista                        | admin | admin_calidad | cubicador | usc   | externo | cliente |
| ---------------------------- |:-----:|:------:|:---------:|:-----:|:-------:|:-------:|
| KPIs generales               |  ✅   |  ✅\*  |    ✅     | ✅\*  |  ✅\*   |   ✅    |
...
> **"propios"**: externo ve reclamos donde es `cubicador_asignado` o `respuesta_por`; usc ve donde es `creado_por` o `asignado_a`. Admin, admin_calidad y cubicador ven todo (global).
...
> ¹ admin_calidad no puede operar sobre usuarios con rol `admin` ni `admin_calidad`.
...
> **Enviar informe por correo**: al enviar se registra un seguimiento automático indicando quién envió el PDF y a qué destinatario(s). Solo admin, admin_calidad, o el USC propietario (creado_por o asignado_a) pueden enviar.
...
3. **Pedidos, calculistas, constructoras** — restringidos a admin/admin_calidad en backend.
4. **admin_calidad** vs **admin**: admin_calidad no puede crear usuarios admin/admin_calidad, no puede operar sobre usuarios admin/admin_calidad, no puede reset DB ni limpiar tablas.
