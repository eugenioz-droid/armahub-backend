...
@router.get("/admin/migrar-imagenes-final")
def migrar_imagenes_final():
    """Migración final a nueva nomenclatura ImagenesRegistro/ImagenesAnalisis."""
    try:
        with get_conn() as conn:
            with conn.cursor() as cur:
        ...
        return {
            "ok": True,
            "migradas_registro": migradas_registro,
            "migradas_analisis": migradas_analisis,
            "total_migradas": migradas_registro + migradas_analisis,
            "estado_antes": estado_antes,
            "estado_despues": estado_despues,
            "mensaje": "Migración completada a nueva nomenclatura"
        }
